...
#loading dataset
df=pd.read_csv(r'/home/skywalker/Documents/ML Projects/data_mobile_price_range.csv')
...
if st.button('Predict'):
    dict={'screen_area':sc_height*sc_wid, 'n_cores':n_cores,'int_memory':int_mem,'mobile_wt':mob_weight,
      'px_area':px_height*px_width,'ram':ram,'battery_power':battery_pow}
    ...
    #Loading saved model
    loaded_model = pickle.load(open(r'/home/skywalker/Documents/ML Projects/mobile_price_predict_new.sav', 'rb'))
