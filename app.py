...
#loading dataset
df=pd.read_csv(r'C:/Users/HP/Desktop/Quizes/Capstone 3/data_mobile_price_range.csv')
...
if st.button('Predict'):
    ...
    #Loading saved model
    loaded_model = pickle.load(open(r'C:/Users/HP/Desktop/Quizes/Capstone 3/mobile_price_predict.sav', 'rb'))
